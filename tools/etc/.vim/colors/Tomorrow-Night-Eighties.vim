...
let s:red = "ff5f5f"
let s:light_red = "f4005f"
let s:dark_red = "f2777a"
let s:orange = "f99157"
let s:yellow = "ffcc66"
let s:green = "99cc99"
let s:light_green = "87af5f"
let s:aqua = "009999"
let s:blue = "6ad8d8"
let s:purple = "ce88ce"
"let s:purple = "cc99cc"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Delimiter", s:white, "", "none")
	...
	call <SID>X("Operator", s:light_green, "", "none")
	...
	" C++ Highlighting
	call <SID>X("cCustomParen", s:white, "", "")
	call <SID>X("cCustomScope", s:yellow, "", "")
	call <SID>X("cCustomClass", s:green, "", "")
